				...
				<div class="row">
					<div class="col-md-4 gallery">
						...
						<div class="img">
							...
							<div class="overlay">
								<a href="{{url('gallery/visit')}}" class="expand"><i
					...
					<div class="col-md-4 gallery">
						...
						<div class="img">
							...
							<div class="overlay">
								<a href="{{url('gallery/sports')}}"
									class="expand"><i class="fa fa-hand-o-right"></i></a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-4 gallery">
						...
						<div class="img">
							...
							<div class="overlay">
								<a href="{{url('gallery/programme')}}" class="expand"><i
										class="fa fa-hand-o-right"></i></a>
								<a class="close-overlay hidden">x</a>
							</div>
						</div>

<section class="history">
    ...
    <figure class="thumb col-md-6 col-sm-6 col-xs-6">
        <img src="{{asset('images/history/44788.jpg')}}" class="img-responsive img-resize" alt="Image">
    </figure>
    <div class="section-content">
        <p class="description"><big>T</big>he renowned madrasah of Chandpur district is Razapur Siddiqia Islamia Hafizia Madrasah
            ...
            examination the madrasah has good reputation, and Last 10 years in Bangladesh.
        </p>
    </div>
</section>
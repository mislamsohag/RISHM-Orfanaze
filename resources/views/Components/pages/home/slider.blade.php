<div class="slider-wrapper theme-default">
        <div id="slider" class="nivoSlider">
                <a href="{{url('Javascript:;')}}"> <img src="{{asset('images/slides/65182.jpg')}}"
                ...
                <a href="{{url('Javascript:;')}}"> <img src="{{asset('images/slides/46022.jpg')}}"
                                ...
                                alt="Slider Image"></a>
                <a href="{{url('Javascript:;')}}"> <img src="{{asset('images/slides/49591.jpg')}}"
                ...
                <a href="{{url('Javascript:;')}}"> <img src="{{asset('images/slides/53144.jpg')}}"

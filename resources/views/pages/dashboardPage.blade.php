                                ...
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                    ...
                                    <div class="mt-3 mt-lg-0">
                                        <form action="javascript:void(0);">
                                            <div class="row g-3 mx-1 align-items-center">
                                                <div class="col-auto">
                                                   <a type="button" href="{{url('category.add')}}" class="btn btn-soft-primary">
                                    ...
                                    <div class="mt-3 mt-lg-0 mx-2">
                                        <form action="javascript:void(0);">
                                            <div class="row g-3 mb-0 align-items-center">
                                               <div class="col-auto">
                                                    <a type="button" href="{{url('brand.add')}}" class="btn btn-soft-secondary">
                                                        <i class="ri-add-circle-line align-middle me-1"></i>
                                                        Brand Add
                                                    </a>
                                                </div>
                                    ...
                                    <div class="mt-3 mt-lg-0">
                                        <form action="javascript:void(0);">
                                            <div class="row g-3 mb-0 align-items-center">
                                               <div class="col-auto">
                                                    <a type="button" href="{{url('add-product')}}" class="btn btn-soft-primary">
                                                        <i class="ri-add-circle-line align-middle me-1"></i>
                                                        Product Add
                                                    </a>
                                                </div>

...
<footer class="footer">
    <div class="bottom-bar">
        <div class="container">
            <div class="row">
                <small class="copyright col-md-6 col-sm-12 col-xs-12">Copyright &copy; রাজাপুর ছিদ্দিকিয়া হাফিজিয়া মাদ্রাসা-2023; Developed by <a href="{{url('#')}}">SohagTech</a></small>
                <ul class="social pull-right col-md-4 col-sm-12 col-xs-12">
                    ...
                    <li><a href="{{url('#')}}" ><i class="fa fa-skype"></i></a></li> 
